...
namespace WPFBacNetApiSample
{
	...
	{
		private List<LightZone> LightZones { get; set; }

		public LightControl()
		{
			InitLightZones();
			MyViewModel.ValuesChanged += OnValueChanged;
		}

		private void OnValueChanged(string address, string oldvalue, string newvalue)
		{
			var zoneWithChangedSetpoint = LightZones.FirstOrDefault(l => l.SetPointAddress == address);
			...
			var zoneWithChangedInput = LightZones.FirstOrDefault(l => l.InputAddress == address);
		...
		private void WriteToNetwork(string address, string newvalue)
		{
			...
			MyViewModel.Bacnet[dev].Objects[addressList[1]].BeginSet(newvalue);
		}

		private void InitLightZones()
		{
			LightZones = new List<LightZone>();
			/*LightZones.Add(new LightZone { InputAddress = "200.BV1", OutputAddresses = new List<string> { "17811.AO111" }, SetPointAddress = "200.AV2" });
			LightZones.Add(new LightZone { InputAddress = "200.BV2", OutputAddresses = new List<string> { "17811.AO112" }, SetPointAddress = "200.AV2" });
			LightZones.Add(new LightZone { InputAddress = "200.BV3", OutputAddresses = new List<string> { "17811.AO113" }, SetPointAddress = "200.AV2" });
			LightZones.Add(new LightZone { InputAddress = "200.BV4", OutputAddresses = new List<string> { "17811.AO114" }, SetPointAddress = "200.AV2" });
			LightZones.Add(new LightZone { InputAddress = "200.BV5", OutputAddresses = new List<string> { "17811.AO115" }, SetPointAddress = "200.AV2" });
			LightZones.Add(new LightZone { InputAddress = "200.BV6", OutputAddresses = new List<string> { "17811.AO116" }, SetPointAddress = "200.AV2" });*/
